...
import { addDoc, collection, CollectionReference, DocumentData, serverTimestamp, DocumentReference, onSnapshot, Timestamp, query, orderBy } from 'firebase/firestore';
...
const Chat = () => {
    ...
    const sendMessage = async (e: React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
        e.preventDefault();
        //channelscollectionの中にあるmessagescollectionの中にメッセージ情報を入れる
